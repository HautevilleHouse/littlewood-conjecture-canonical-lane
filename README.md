...
Canonical Lane research workspace for a flagship problem in Diophantine approximation:
proving Littlewood's conjecture through an admissible homogeneous-dynamics closure architecture.

## Main Manuscript

- [paper/LITTLEWOOD_CONJECTURE_PREPRINT.md](paper/LITTLEWOOD_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `LITTLEWOOD_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/LITTLEWOOD_CONJECTURE_PREPRINT.md`.
...
Current LC runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/lc_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/lc_closure_guard.py`.
...
- Manuscript target: [paper/LITTLEWOOD_CONJECTURE_PREPRINT.md](paper/LITTLEWOOD_CONJECTURE_PREPRINT.md)
