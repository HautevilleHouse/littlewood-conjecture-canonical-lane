...
mkdir -p .tmp/lc_closure
cp artifacts/stitch_constants.json .tmp/lc_closure/stitch_constants.json
cp artifacts/constants_registry.json .tmp/lc_closure/constants_registry.json
