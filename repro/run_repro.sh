...
mkdir -p .codex_tmp/lc_closure
cp artifacts/stitch_constants.json .codex_tmp/lc_closure/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/lc_closure/constants_registry.json
